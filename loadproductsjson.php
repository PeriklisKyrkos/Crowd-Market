...
?>
			<div class="w3-container" id="showcase">
				<h1>Ανέβασμα αρχείου προϊόντων</h1><br>
					<form action="insertproductsjson.php" method="post" enctype="multipart/form-data">
						<div class="row">
							<label for="frm_importfile">Επιλέξτε αρχείο προϊόντων (JSON):</label>
						</div>
						<div class="row">
