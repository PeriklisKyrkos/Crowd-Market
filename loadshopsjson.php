...
?>
			<div class="w3-container" id="showcase">
				<h1>Ανέβασμα αρχείου καταστημάτων</h1><br>
					<form action="insertshopsjson.php" method="post" enctype="multipart/form-data">
						<div class="row">
							<label for="frm_importfile">Επιλέξτε αρχείο καταστημάτων (JSON):</label>
						</div>
						<div class="row">
